...
const quizData = [
  {
    question: 'Кто главный адмен аниме клаба?',
    a: 'Алмаз',
    b: 'Денис',
    c: 'Наиль',
    correct: 'a',
  ...
  {
    question: 'Сколько адменов в этом канала?',
    a: '19',
    b: '3',
    c: '11',
    correct: 'a',
...
function pr()
{
	...
	setTimeout(() =>
	{
		...
		crI("./TG-logo.svg", 40, 80, 50, 50, "https://t.me/review_for_kanye");
	}, 1300);
}
